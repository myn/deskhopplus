...
const keyConfig = (() => {
  ...
  Object.entries({
    ...
    printscreen: 0x46, scrolllock: 0x47, insert: 0x49, home: 0x4a,
    ...
    kp_enter: 0x58, kp1: 0x59, kp2: 0x5a, kp3: 0x5b, kp4: 0x5c,
    kp5: 0x5d, kp6: 0x5e, kp7: 0x5f, kp8: 0x60, kp9: 0x61,
    kp0: 0x62, kp_period: 0x63, lctrl: 0xe0, lshift: 0xe1,
    lalt: 0xe2, lgui: 0xe3, rctrl: 0xe4, rshift: 0xe5,
    ralt: 0xe6, rgui: 0xe7
  }).forEach(([name, usage]) => names.set(name, usage));
