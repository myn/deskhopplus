...
| 0x22 | POS_RESPONSE | h→d | `k_h2b` | `chain_index:u8` `x:u16` `y:u16` (0–65535 normalized within the current monitor) |
...
- **Twelve totals, not one.** Each names a different seam and each seam has a different remedy. A
